 ...
 * AllDisplayPage
 *
 * at the 'investmentDisplay' route
 *
 */
...
const data={
	...
	children: [
	{
		...
		children: [
			...
			{ name: '地下发电厂房工程Z06', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/investmentDisplay/MainView/地下发电厂房工程Z06'}, fold: "none" },
	...
	,
		{
			...
			actionData:{},
			children: [
				{ name: '下游河道整治工程', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/investmentDisplay/MainView/一次系统'}, fold: "none" },
				{ name: '旦坡崩坡机体处理工程', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/investmentDisplay/MainView/气系统'}, fold: "none" },
			]
		},
		{
			name: '辅助工程',
...
class InvestmentDisplay extends React.Component {
