 ...
 * AllDisplayPage
 *
 * at the 'InvestmentGeneralSituation' route
 *
 */
...
const data={
	...
	children: [
	{
		...
		actionData:{},
		children: [
			{ name: '输水工程', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/InvestmentGeneralSituation/MainView/输水工程'}, fold: "none" },
			{ name: '地下发电厂房工程Z06', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/InvestmentGeneralSituation/MainView/地下发电厂房工程Z06'}, fold: "none" },
			{ name: '升压变电工程', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/InvestmentGeneralSituation/MainView/升压变电工程'}, fold: "none" },
			{ name: '其他电工程', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/InvestmentGeneralSituation/MainView/其他电工程'}, fold: "none" },
		]
	}
	,
		{
			...
			actionData:{},
			children: [
				{ name: '下游河道整治工程', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/InvestmentGeneralSituation/MainView/一次系统'}, fold: "none" },
				{ name: '旦坡崩坡机体处理工程', icon: "file", action: 'link', actionData:{linkURL:'/allDisplay/InvestmentGeneralSituation/MainView/气系统'}, fold: "none" },
			]
		},
		{
			name: '辅助工程',
...
class InvestmentGeneralSituation extends React.Component {
...
export default InvestmentGeneralSituation;
